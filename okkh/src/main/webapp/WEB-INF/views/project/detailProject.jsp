												...
												<div class="card">
													...
													<div class="card-content">
														<div class="card-body">
															...
															<div class="UJ-WriteHeader">
																...
																<c:choose>
																	<c:when
																		test="${not empty book and book.memNo eq loginMember.memNo}">
																		<img src="https://holaworld.io/images/info/bookmark_filled.png"
																			style="float:right; padding-right: 40px; "
																			onclick="bookmark(event);" class="bookmark">
																	</c:when>

																	<c:otherwise>
																		<img src="https://holaworld.io/images/info/bookmark.png"
																			style="float:right; padding-right: 40px; "
																			onclick="bookmark(event);" class="bookmark">
																	</c:otherwise>
																...
																<div style="font-size: 17px; " id="buttonArea">
																	...
																	<c:choose>
																		...
																		<c:when test="${empty loginMember }">
																			<!-- 아직 로그인을 안했을 경우 -->
																			<button
																				style="float: right; border: 0; height: 60px; "
																				class="btn btn-primary" disabled>프로젝트
																				신청하기(로그인 후 신청가능)</button>
																		</c:when>

																		<c:when
																			test="${pro.memNo ne loginMember.memNo and pro.proStatus == 'N'  }">
																			<!-- 프로젝트 모집이 마감이 되었을 경우 -->

																			<button
																				style="float: right; border: 0; height: 50px; "
																				class="btn btn-primary" disabled>프로젝트
																				모집마감</button>
																		...
																		<c:when
																			test="${pro.memNo eq loginMember.memNo and pro.proStatus == 'Y'}">
																			<!-- 작성자고, 프로젝트 아직 모집 미완료일때 -->

																			<button
																				style="float: right; border: 0; height: 50px; "
																				class="btn btn-primary"
																				onclick="location.href='recruitDone.pro?pno=' + ${pro.proNo }">모집
																				완료하기</button>
																		</c:when>

																		<c:when
																			test="${pro.memNo eq loginMember.memNo and pro.proStatus == 'N'}">
																			<!-- 작성자고, 모집이 완료되었을 경우 재모집버튼이 보임 -->

																			<button
																				style="float: right; border: 0; height: 50px; "
																				class="btn btn-light-secondary"
																				onclick="location.href='recruitReturn.pro?pno=' + ${pro.proNo }">다시
																				모집하기</button>
																		</c:when>
																		...
																		<c:when
																			...
																			<button
																				style="float: right; border: 0; height: 50px; "
																				class="btn btn-primary"
																				id="enrollProject">프로젝트 신청하기</button>
																		</c:when>
																		...
																		<c:when
																			...
																			<button
																				style='float: right; border: 0; height: 50px;'
																				class='btn btn-light-secondary'
																				disabled> 이미 참여한 다른 프로젝트가 있습니다</button>
															...
															<div class="row">
																<div class="col-md-6 col-12">
																	<div class="form-group">
																		...
																		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span
																			name="peoNo">${pro.proMember }명</span>
																	</div>
																</div>
																<div class="col-md-6 col-12">
																	...
																	<div class="form-group">
																		...
																		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span
																			name="proDeadLine">${pro.proDeadLine}</span>
																	</div>
																...
																<div class="col-md-6 col-12">
																	...
																	<div class="form-group">
																		...
																		<c:set var="techStacks"
																			value="${fn:split(pro.proStack, ',')}" />
																		<c:forEach items="${techStacks}"
																			var="techStack">
																			<c:set var="src"
																				value="https://holaworld.io/images/languages/${techStack}.svg" />

																			<button type="button" class="btn"
																				style="border:1px solid lightgray; border-radius: 50px; height: 52px;padding-left: 0; margin-right: 10px; ">
																...
																<div class="col-md-6 col-12" style="margin-top:10px;">
																	...
																	<div class="form-group">
																		...
																		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span
																			name="endDate">${pro.proStartDate }</span>
																	</div>
																</div>
																...
																<div class="col-md-6 col-12">
																	<div class="form-group">
																		...
																		<c:set var="position"
																			value="${fn:split(pro.proPosition,',') }" />

																		<c:forEach var="po" items="${position }">
																			<button
																				style="border:0; border-radius:50px; width:100px; height:40px; box-sixing:border">${po}</button>
																		</c:forEach>
																	</div>
																</div>
																...
																<div class="col-md-6 col-12">
																	<div class="form-group">
																		...
																		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span
																			name="period">${pro.proPeriod }</span>
																	</div>
																</div>
																...
																<div class="col-12 d-flex justify-content-end">
																	<c:choose>
																		<c:when
																			test="${loginMember.memNo == pro.memNo}">
																			<!--  
	                                               ...
	                                               -->
																			...
																			<button type="button"
																				...
																				onclick="location.href='updateFormProject.pro?pno='+ ${pro.proNo}">수정하기</button>
																			<button type="button"
																				class="btn btn-light-secondary me-1 mb-1"
																				onclick="location.href='deleteProject.pro?pno='+ ${pro.proNo}">삭제하기</button>
																			<button type="button"
																				class="btn btn-light-secondary me-1 mb-1"
																				onclick="location.href='recruitList.pro'">뒤로가기</button>
															...
															<div id="UJ-reply">
																...
																<table class="replyTable" align="center" width=900>
																	...
																	<thead>
																				...
																				<c:when
																					...
																					<th colspan="4">
																						...
																						<button type="button"
																							style="width: 90px;"
																							class="btn btn-primary"
																							onclick="UJinsertReply();">작성</button>
																		...
																		<tr>
																			<td
																				style="padding-left:10px; padding-bottom:20px; font-size:18px; font-weight:900;">
																				댓글 (<span id="rcount">0</span>) </td>
																		</tr>
