...
-- 멤버 테이블 샘플데이터 5개
INSERT INTO MEMBER (MEM_NO, MEM_ID, MEM_TOKEN, MEM_INTRO, CREATE_DATE, STATUS, STACK_NAME, TEAM, TEAM_STATUS,GIT_NICK) VALUES (0, '0000', '00000', '자기소개1', DEFAULT, DEFAULT, 'JAVA, AWS', 1, 'Y','호빵천사친구');
INSERT INTO MEMBER (MEM_NO, MEM_ID, MEM_TOKEN, MEM_INTRO, CREATE_DATE, STATUS, STACK_NAME, TEAM, TEAM_STATUS,GIT_NICK) VALUES (SEQ_MEM.NEXTVAL, '11111', '21451', '자기소개1', DEFAULT, DEFAULT, 'JAVA, AWS', 1, 'Y','호빵천사');
INSERT INTO MEMBER (MEM_NO, MEM_ID, MEM_TOKEN, MEM_INTRO, CREATE_DATE, STATUS, STACK_NAME, TEAM, TEAM_STATUS,GIT_NICK) VALUES (SEQ_MEM.NEXTVAL, '22222', '46747', '자기소개2', DEFAULT, DEFAULT, 'JAVA, AWS', 1, 'Y','찐빵천사');
INSERT INTO MEMBER (MEM_NO, MEM_ID, MEM_TOKEN, MEM_INTRO, CREATE_DATE, STATUS, STACK_NAME, TEAM, TEAM_STATUS,GIT_NICK) VALUES (SEQ_MEM.NEXTVAL, '33333', '21125', '자기소개3', DEFAULT, DEFAULT, 'JAVA, AWS', 1, 'Y','피자빵천사');
INSERT INTO MEMBER (MEM_NO, MEM_ID, MEM_TOKEN, MEM_INTRO, CREATE_DATE, STATUS, STACK_NAME, TEAM, TEAM_STATUS,GIT_NICK) VALUES (SEQ_MEM.NEXTVAL, '44444', '84849', '자기소개4', DEFAULT, DEFAULT, 'JAVA, AWS', 1, 'Y','마늘빵천사');
INSERT INTO MEMBER (MEM_NO, MEM_ID, MEM_TOKEN, MEM_INTRO, CREATE_DATE, STATUS, STACK_NAME, TEAM, TEAM_STATUS,GIT_NICK) VALUES (SEQ_MEM.NEXTVAL, '55555', '28922', '자기소개5', DEFAULT, DEFAULT, 'JAVA, AWS', 1, 'Y','붕어빵천사');
...
CREATE TABLE CHAT_MEMBER (
   ...
   ROOM_NO NUMBER NOT NULL REFERENCES CHAT_ROOM,
   STATUS VARCHAR2(1) DEFAULT 'Y' NOT NULL 
);

INSERT INTO CHAT_MEMBER (MEM_NO, ROOM_NO) VALUES (1,1);
INSERT INTO CHAT_MEMBER (MEM_NO, ROOM_NO) VALUES (2,1);
INSERT INTO CHAT_MEMBER (MEM_NO, ROOM_NO) VALUES (3,1);
INSERT INTO CHAT_MEMBER (MEM_NO, ROOM_NO) VALUES (5,2);
...
COMMENT ON COLUMN MY_PROJECT.REF_TEAM_NO IS '참조 팀 번호(참조 프로젝트 모집번호)';
COMMENT ON COLUMN MY_PROJECT.MYPRO_TITLE IS '프로젝트명';
COMMENT ON COLUMN MY_PROJECT.MYPRO_TYPE IS '프로젝트 타입';
COMMENT ON COLUMN MY_PROJECT.MYPRO_MEMBER IS '프로젝트 멤버';
COMMENT ON COLUMN MY_PROJECT.CREATE_DATE IS '프로젝트 생성일';
COMMENT ON COLUMN MY_PROJECT.STATUS IS '프로젝트 상태(Y:존재/N:삭제)';
COMMENT ON COLUMN MY_PROJECT.MYPRO_STATUS IS '프로젝트 진행/완료(Y:진행/N:완료)';

-- 나의 프로젝트 샘플데이터
INSERT INTO MY_PROJECT (MYPRO_NO, REF_TEAM_NO, MYPRO_TITLE, MYPRO_TYPE, MYPRO_MEMBER, CREATE_DATE, STATUS, MYPRO_STATUS) VALUES (SEQ_MYPRO.NEXTVAL, 1, 'OKKH', '팀 프로젝트', '11111,22222,33333', SYSDATE, DEFAULT, DEFAULT);
INSERT INTO MY_PROJECT (MYPRO_NO, REF_TEAM_NO, MYPRO_TITLE, MYPRO_TYPE, MYPRO_MEMBER, CREATE_DATE, STATUS, MYPRO_STATUS) VALUES (SEQ_MYPRO.NEXTVAL, 2, '티켓딱대', '팀 프로젝트', '11111,44444,55555', SYSDATE, DEFAULT, 'N');
INSERT INTO MY_PROJECT (MYPRO_NO, REF_TEAM_NO, MYPRO_TITLE, MYPRO_TYPE, MYPRO_MEMBER, CREATE_DATE, STATUS, MYPRO_STATUS) VALUES (SEQ_MYPRO.NEXTVAL, 3, '계산기 만들기', '개인 프로젝트', '11111', SYSDATE, DEFAULT, 'N');
