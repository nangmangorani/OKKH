...
-- 멤버 테이블 샘플데이터 5개
INSERT INTO MEMBER (MEM_NO, MEM_ID, MEM_TOKEN, GIT_NICK, OKKH_NICK, MEM_INTRO, CREATE_DATE, STATUS, FILE_NO, STACK) VALUES (SEQ_MEM.NEXTVAL, '11111', '21451', '닉네임1', DEFAULT, '자기소개1', DEFAULT, DEFAULT, 1, '자바, 파이썬');
INSERT INTO MEMBER (MEM_NO, MEM_ID, MEM_TOKEN, GIT_NICK, OKKH_NICK, MEM_INTRO, CREATE_DATE, STATUS, FILE_NO, STACK) VALUES (SEQ_MEM.NEXTVAL, '22222', '56436', '닉네임2', DEFAULT, '자기소개2', DEFAULT, DEFAULT, 1, '자바스크립트, 리액트');
INSERT INTO MEMBER (MEM_NO, MEM_ID, MEM_TOKEN, GIT_NICK, OKKH_NICK, MEM_INTRO, CREATE_DATE, STATUS, FILE_NO, STACK) VALUES (SEQ_MEM.NEXTVAL, '33333', '80600', '닉네임3', DEFAULT, '자기소개3', DEFAULT, DEFAULT, 1, '오라클, 마이바티스');
INSERT INTO MEMBER (MEM_NO, MEM_ID, MEM_TOKEN, GIT_NICK, OKKH_NICK, MEM_INTRO, CREATE_DATE, STATUS, FILE_NO, STACK) VALUES (SEQ_MEM.NEXTVAL, '44444', '80685', '닉네임4', DEFAULT, '자기소개4', DEFAULT, DEFAULT, 1, 'C++, C');
INSERT INTO MEMBER (MEM_NO, MEM_ID, MEM_TOKEN, GIT_NICK, OKKH_NICK, MEM_INTRO, CREATE_DATE, STATUS, FILE_NO, STACK) VALUES (SEQ_MEM.NEXTVAL, '55555', '68586', '닉네임5', DEFAULT, '자기소개5', DEFAULT, DEFAULT, 1, 'HTML, CSS');
...
CREATE TABLE MY_PROJECT(
    ...
    OWNER NUMBER REFERENCES MEMBER,
    TEAMMATE VARCHAR2(4000)
);
-- 나의 프로젝트 코멘트
COMMENT ON COLUMN MY_PROJECT.MYPRO_NO IS '프로젝트 모집번호';
...
COMMENT ON COLUMN MY_PROJECT.STATUS IS '프로젝트 삭제여부';
COMMENT ON COLUMN MY_PROJECT.MYPRO_STATUS IS '프로젝트 완료여부';
COMMENT ON COLUMN MY_PROJECT.OWNER IS '팀장 회원번호';
COMMENT ON COLUMN MY_PROJECT.TEAMMATE IS '팀원목록';

-- 나의 프로젝트 샘플데이터
INSERT INTO MY_PROJECT (MYPRO_NO, MYPRO_TITLE, MYPRO_TYPE, CREATE_DATE, STATUS, MYPRO_STATUS, OWNER, TEAMMATE) VALUES (SEQ_MYPRO.NEXTVAL, 'OKKY', '파이널 프로젝트', SYSDATE, DEFAULT, DEFAULT, 1, '111111, 222222, 333333');
INSERT INTO MY_PROJECT (MYPRO_NO, MYPRO_TITLE, MYPRO_TYPE, CREATE_DATE, STATUS, MYPRO_STATUS, OWNER, TEAMMATE) VALUES (SEQ_MYPRO.NEXTVAL, '계산기 만들기', '개인 프로젝트', SYSDATE, DEFAULT, DEFAULT, 1, '111111, 222222, 333333');
INSERT INTO MY_PROJECT (MYPRO_NO, MYPRO_TITLE, MYPRO_TYPE, CREATE_DATE, STATUS, MYPRO_STATUS, OWNER, TEAMMATE) VALUES (SEQ_MYPRO.NEXTVAL, '티켓딱대', '세미 프로젝트', SYSDATE, DEFAULT, DEFAULT, 1, '111111, 222222, 333333');
INSERT INTO MY_PROJECT (MYPRO_NO, MYPRO_TITLE, MYPRO_TYPE, CREATE_DATE, STATUS, MYPRO_STATUS, OWNER, TEAMMATE) VALUES (SEQ_MYPRO.NEXTVAL, 'TO-DO LIST', '개인 프로젝트', SYSDATE, DEFAULT, DEFAULT, 1, '111111, 222222, 333333');
