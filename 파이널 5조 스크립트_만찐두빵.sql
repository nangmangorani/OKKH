...
-- 기술 스택 샘플 데이터
INSERT INTO STACK VALUES (SEQ_STA.NEXTVAL, '프론트엔드','javascript','https://holaworld.io/images/languages/javascript.svg'); 
INSERT INTO STACK VALUES (SEQ_STA.NEXTVAL, '프론트엔드','typescript','https://holaworld.io/images/languages/typescript.svg'); 
INSERT INTO STACK VALUES (SEQ_STA.NEXTVAL, '프론트엔드','react','https://holaworld.io/images/languages/react.svg'); 
INSERT INTO STACK VALUES (SEQ_STA.NEXTVAL, '프론트엔드','vue','https://holaworld.io/images/languages/vue.svg'); 
INSERT INTO STACK VALUES (SEQ_STA.NEXTVAL, '프론트엔드','svelte','https://holaworld.io/images/languages/svelte.svg'); 
INSERT INTO STACK VALUES (SEQ_STA.NEXTVAL, '프론트엔드','nextjs','https://holaworld.io/images/languages/nextjs.svg'); 
INSERT INTO STACK VALUES (SEQ_STA.NEXTVAL, '백엔드','java','https://holaworld.io/images/languages/java.svg'); 
INSERT INTO STACK VALUES (SEQ_STA.NEXTVAL, '백엔드','spring','https://holaworld.io/images/languages/spring.svg'); 
INSERT INTO STACK VALUES (SEQ_STA.NEXTVAL, '백엔드','nodejs','https://holaworld.io/images/languages/nodejs.svg'); 
INSERT INTO STACK VALUES (SEQ_STA.NEXTVAL, '백엔드','nestjs','https://holaworld.io/images/languages/nestjs.svg'); 
INSERT INTO STACK VALUES (SEQ_STA.NEXTVAL, '백엔드','go','https://holaworld.io/images/languages/go.svg');
INSERT INTO STACK VALUES (SEQ_STA.NEXTVAL, '백엔드','kotlin','https://holaworld.io/images/languages/kotlin.svg'); 
INSERT INTO STACK VALUES (SEQ_STA.NEXTVAL, '백엔드','express','https://holaworld.io/images/languages/express.svg'); 
INSERT INTO STACK VALUES (SEQ_STA.NEXTVAL, '백엔드','mysql','https://holaworld.io/images/languages/mysql.svg'); 
INSERT INTO STACK VALUES (SEQ_STA.NEXTVAL, '백엔드','mongodb','https://holaworld.io/images/languages/mongodb.svg');
INSERT INTO STACK VALUES (SEQ_STA.NEXTVAL, '백엔드','python','https://holaworld.io/images/languages/python.svg'); 
INSERT INTO STACK VALUES (SEQ_STA.NEXTVAL, '백엔드','django','https://holaworld.io/images/languages/django.svg');
INSERT INTO STACK VALUES (SEQ_STA.NEXTVAL, '백엔드','php','https://holaworld.io/images/languages/php.svg'); 
INSERT INTO STACK VALUES (SEQ_STA.NEXTVAL, '백엔드','graphql','https://holaworld.io/images/languages/graphql.svg'); 
INSERT INTO STACK VALUES (SEQ_STA.NEXTVAL, '백엔드','firebase','https://holaworld.io/images/languages/firebase.svg'); 
INSERT INTO STACK VALUES (SEQ_STA.NEXTVAL, '모바일','flutter','https://holaworld.io/images/languages/flutter.svg'); 
INSERT INTO STACK VALUES (SEQ_STA.NEXTVAL, '모바일','swift','https://holaworld.io/images/languages/swift.svg'); 
INSERT INTO STACK VALUES (SEQ_STA.NEXTVAL, '모바일','reactnative','https://holaworld.io/images/languages/reactnative.svg'); 
INSERT INTO STACK VALUES (SEQ_STA.NEXTVAL, '모바일','unity','https://holaworld.io/images/languages/unity.svg'); 
INSERT INTO STACK VALUES (SEQ_STA.NEXTVAL, '기타','aws','https://holaworld.io/images/languages/aws.svg'); 
INSERT INTO STACK VALUES (SEQ_STA.NEXTVAL, '기타','kubernetes','https://holaworld.io/images/languages/kubernetes.svg'); 
INSERT INTO STACK VALUES (SEQ_STA.NEXTVAL, '기타','docker','https://holaworld.io/images/languages/docker.svg'); 
INSERT INTO STACK VALUES (SEQ_STA.NEXTVAL, '기타','git','https://holaworld.io/images/languages/git.svg'); 
INSERT INTO STACK VALUES (SEQ_STA.NEXTVAL, '기타','figma','https://holaworld.io/images/languages/figma.svg'); 
INSERT INTO STACK VALUES (SEQ_STA.NEXTVAL, '기타','zeplin','https://holaworld.io/images/languages/zeplin.svg'); 
INSERT INTO STACK VALUES (SEQ_STA.NEXTVAL, '기타','jest','https://holaworld.io/images/languages/jest.svg'); 
...
-- 사진 테이블 샘플데이터
INSERT INTO ATTACHMENT (FILE_NO, REF_BNO, ORIGIN_NAME, CHANGE_NAME, FILE_PATH, UPLOAD_DATE, STATUS, CATEGORY) VALUES (SEQ_ATTA.NEXTVAL, 1, '호빵.jpg', '2023101610204578.jpg', 'resources/upfiles/', DEFAULT, DEFAULT, 'M');
...
COMMENT ON COLUMN MEMBER.AVATAR_URL IS '깃허브 프로필 사진';
...
COMMENT ON COLUMN MEMBER.STACK IS '기술스택';
COMMENT ON COLUMN MEMBER.TEAM IS '참여 프로젝트 팀';
COMMENT ON COLUMN MEMBER.TEAM_STATUS IS '참여상태(Y:확정, N:임시)';

-- 멤버 테이블 샘플데이터 5개
INSERT INTO MEMBER (MEM_NO, MEM_ID, MEM_TOKEN, GIT_NICK, AVATAR_URL, MEM_INTRO, CREATE_DATE, STATUS, STACK, TEAM, TEAM_STATUS) VALUES (SEQ_MEM.NEXTVAL, '11111', '21451', '닉네임1', 'https://mblogthumb-phinf.pstatic.net/MjAyMjEyMDRfMjk1/MDAxNjcwMTM0MzQxODYy.-bwZuKUBCl5lStmN48I0agvEAunWWFYzcQb5AoLImhwg.yMoOCcK-zeiPGMCNuEjQRV51U9xTqOKqVDbmQdGns_Yg.JPEG.goms1101/IMG_3400.JPG?type=w800', '자기소개1', DEFAULT, DEFAULT, '자바, 파이썬', 1, 'Y');
INSERT INTO MEMBER (MEM_NO, MEM_ID, MEM_TOKEN, GIT_NICK, AVATAR_URL, MEM_INTRO, CREATE_DATE, STATUS, STACK, TEAM, TEAM_STATUS) VALUES (SEQ_MEM.NEXTVAL, '22222', '56436', '닉네임2', 'https://mblogthumb-phinf.pstatic.net/MjAyMjEyMDRfMjAg/MDAxNjcwMTM0MzQ2MzI1.60eBNkj8BiFMZZ2TEjaNKfkQBMLbs9t-r-B5dt2kcusg.MpGfZY-SlIoDyTHS9haziKlNqXU616HKdSbG_gFUe1sg.JPEG.goms1101/IMG_3421.JPG?type=w800', '자기소개2', DEFAULT, DEFAULT, '자바스크립트, 리액트', 1, 'Y');
INSERT INTO MEMBER (MEM_NO, MEM_ID, MEM_TOKEN, GIT_NICK, AVATAR_URL, MEM_INTRO, CREATE_DATE, STATUS, STACK, TEAM, TEAM_STATUS) VALUES (SEQ_MEM.NEXTVAL, '33333', '80600', '닉네임3', 'https://mblogthumb-phinf.pstatic.net/MjAyMjEyMDRfNTEg/MDAxNjcwMTM0MzQyMzc2.hKZlLb7mpDBpn8uUKmIo4e-1LXmQ9w81iCAHbtj2sM0g.EdlEMutFjvEnxiJAak_oM6QgRWuusz-Uy1qoGAKpHKUg.JPEG.goms1101/IMG_3413.JPG?type=w400', '자기소개3', DEFAULT, DEFAULT, '오라클, 마이바티스', 1, 'Y');
INSERT INTO MEMBER (MEM_NO, MEM_ID, MEM_TOKEN, GIT_NICK, AVATAR_URL, MEM_INTRO, CREATE_DATE, STATUS, STACK, TEAM, TEAM_STATUS) VALUES (SEQ_MEM.NEXTVAL, '44444', '80685', '닉네임4', 'https://mblogthumb-phinf.pstatic.net/MjAyMjEyMDRfNjEg/MDAxNjcwMTM0MzQxOTYy.y_9OPghag6MUoqEcnAzLLV2ZNDSmej5SU3f1j5lM5g0g.KkMUYr0k9ql3TDqG2-SnsC66RVL0Lm7NZ2iSX6BRTuIg.JPEG.goms1101/IMG_3394.JPG?type=w800', '자기소개4', DEFAULT, DEFAULT, 'C++, C', DEFAULT, DEFAULT);
INSERT INTO MEMBER (MEM_NO, MEM_ID, MEM_TOKEN, GIT_NICK, AVATAR_URL, MEM_INTRO, CREATE_DATE, STATUS, STACK, TEAM, TEAM_STATUS) VALUES (SEQ_MEM.NEXTVAL, '55555', '68586', '닉네임5', 'https://image.fmkorea.com/files/attach/new/20191008/486616/2093167063/2261931734/953da8ce0874ea6f3d56a20747129b8f.jpg', '자기소개5', DEFAULT, DEFAULT, 'HTML, CSS', DEFAULT, DEFAULT);
...
COMMENT ON COLUMN PROJECT.STATUS IS '프로젝트 삭제여부';
...
-- 완료된 프로젝트 코멘트
COMMENT ON COLUMN FINPROJECT.FPRO_NO IS '완료된 프로젝트 번호';
COMMENT ON COLUMN FINPROJECT.REF_PNO IS '참조 프로젝트 번호';  -- 혹시 몰라 만든 컬럼
COMMENT ON COLUMN FINPROJECT.FPRO_TITLE IS '완료된 프로젝트 제목';
COMMENT ON COLUMN FINPROJECT.FPRO_README IS '리드미파일';
COMMENT ON COLUMN FINPROJECT.FPRO_CONTENT IS '완료된 프로젝트 내용';
...
-- 캘린더 샘플 데이터 5개
INSERT INTO CALENDAR (CAL_NO, CAL_TITLE, CAL_CONTENT, START_DATE, END_DATE, CAL_CATEGORY, CAL_STATUS, STATUS) VALUES (SEQ_CAL.NEXTVAL, '주제선정', '프로젝트 주제 선정 및 역할 분담', '2023-10-16', '2023-10-16', '업무', DEFAULT, DEFAULT);
INSERT INTO CALENDAR (CAL_NO, CAL_TITLE, CAL_CONTENT, START_DATE, END_DATE, CAL_CATEGORY, CAL_STATUS, STATUS) VALUES (SEQ_CAL.NEXTVAL, '팀 회식', '단합을 위한 회식', '2023-10-21', '2023-10-21', '소셜', DEFAULT, DEFAULT);
INSERT INTO CALENDAR (CAL_NO, CAL_TITLE, CAL_CONTENT, START_DATE, END_DATE, CAL_CATEGORY, CAL_STATUS, STATUS) VALUES (SEQ_CAL.NEXTVAL, '팀 선정', '팀 선정 및 인사', '2023-10-4', '2023-10-4', '업무', 'N', DEFAULT);
INSERT INTO CALENDAR (CAL_NO, CAL_TITLE, CAL_CONTENT, START_DATE, END_DATE, CAL_CATEGORY, CAL_STATUS, STATUS) VALUES (SEQ_CAL.NEXTVAL, '가족과 저녁식사', '가족과 김밥천국에서 저녁식사', '2023-10-17', '2023-10-17', '개인', DEFAULT, DEFAULT);
INSERT INTO CALENDAR (CAL_NO, CAL_TITLE, CAL_CONTENT, START_DATE, END_DATE, CAL_CATEGORY, CAL_STATUS, STATUS) VALUES (SEQ_CAL.NEXTVAL, '페이지 제작', '페이지 제작 및 피드백', '2023-10-17', '2023-10-30', '업무', DEFAULT, DEFAULT);
...
-- 나의 프로젝트 코멘트
COMMENT ON COLUMN MY_PROJECT.MYPRO_NO IS '프로젝트 번호';
COMMENT ON COLUMN MY_PROJECT.REF_PRO_NO IS '프로젝트 모집번호';
COMMENT ON COLUMN MY_PROJECT.MYPRO_TITLE IS '프로젝트명';
COMMENT ON COLUMN MY_PROJECT.MYPRO_TYPE IS '프로젝트 종류';
COMMENT ON COLUMN MY_PROJECT.CREATE_DATE IS '프로젝트 생성일';
COMMENT ON COLUMN MY_PROJECT.STATUS IS '프로젝트 상태';
COMMENT ON COLUMN MY_PROJECT.MYPRO_STATUS IS '프로젝트 진행/완료';

-- 나의 프로젝트 샘플데이터
INSERT INTO MY_PROJECT (MYPRO_NO, REF_PRO_NO, MYPRO_TITLE, MYPRO_TYPE, CREATE_DATE, STATUS, MYPRO_STATUS) VALUES (SEQ_MYPRO.NEXTVAL, 1, 'OKKY', '파이널 프로젝트', SYSDATE, DEFAULT, DEFAULT);
INSERT INTO MY_PROJECT (MYPRO_NO, REF_PRO_NO, MYPRO_TITLE, MYPRO_TYPE, CREATE_DATE, STATUS, MYPRO_STATUS) VALUES (SEQ_MYPRO.NEXTVAL, 2, '계산기 만들기', '개인 프로젝트', SYSDATE, DEFAULT, DEFAULT);
INSERT INTO MY_PROJECT (MYPRO_NO, REF_PRO_NO, MYPRO_TITLE, MYPRO_TYPE, CREATE_DATE, STATUS, MYPRO_STATUS) VALUES (SEQ_MYPRO.NEXTVAL, 3, '티켓딱대', '세미 프로젝트', SYSDATE, DEFAULT, DEFAULT);
...
COMMENT ON COLUMN REPO.REF_PNO IS '참조 프로젝트 번호';

-- 레파지토리 샘플 데이터 5개
INSERT INTO REPO (REPO_NO, REPO_TITLE, REPO_CONTENT, REPO_STATUS, CREATE_DATE, STATUS, REF_PNO) VALUES (SEQ_REPO.NEXTVAL, 'FINAL_HTML', '레파지 내용임돠', DEFAULT, DEFAULT, DEFAULT, 1);
INSERT INTO REPO (REPO_NO, REPO_TITLE, REPO_CONTENT, REPO_STATUS, CREATE_DATE, STATUS, REF_PNO) VALUES (SEQ_REPO.NEXTVAL, 'FINAL_JSP', '레파지 내용임돠', DEFAULT, DEFAULT, DEFAULT, 2);
INSERT INTO REPO (REPO_NO, REPO_TITLE, REPO_CONTENT, REPO_STATUS, CREATE_DATE, STATUS, REF_PNO) VALUES (SEQ_REPO.NEXTVAL, 'FINAL_TEST', '레파지 내용임돠', DEFAULT, DEFAULT, DEFAULT, 3);
INSERT INTO REPO (REPO_NO, REPO_TITLE, REPO_CONTENT, REPO_STATUS, CREATE_DATE, STATUS, REF_PNO) VALUES (SEQ_REPO.NEXTVAL, 'FINAL_TEMPLATE', '레파지 내용임돠', DEFAULT, DEFAULT, DEFAULT, 2);
INSERT INTO REPO (REPO_NO, REPO_TITLE, REPO_CONTENT, REPO_STATUS, CREATE_DATE, STATUS, REF_PNO) VALUES (SEQ_REPO.NEXTVAL, 'FINAL_REAL', '레파지 내용임돠', DEFAULT, DEFAULT, DEFAULT, 1);
...
-- 알림 테이블 샘플데이터
INSERT INTO NOTICE (NOTI_NO, CATEGORY_NAME, NOTI_CONTENT, OCU_TIME, STATUS, MEM_NO) VALUES (SEQ_NOTI.NEXTVAL, '이슈', '00_java-workspace에 새로운 이슈가 발생했습니다.', DEFAULT, DEFAULT, 2);
INSERT INTO NOTICE (NOTI_NO, CATEGORY_NAME, NOTI_CONTENT, OCU_TIME, STATUS, MEM_NO) VALUES (SEQ_NOTI.NEXTVAL, '친구', 'USER03 님이 친구요청을 수락하셨습니다.', DEFAULT, DEFAULT, 3);
INSERT INTO NOTICE (NOTI_NO, CATEGORY_NAME, NOTI_CONTENT, OCU_TIME, STATUS, MEM_NO) VALUES (SEQ_NOTI.NEXTVAL, '개인홍보', 'USER02 님이 고객님의 자기PR에 좋아요를 눌렀습니다.', DEFAULT, DEFAULT, 1);
...
-- 커밋 샘플 데이터 5개
INSERT INTO PRO_COMMIT (COMM_NO, COMM_WRITER, COMM_DATE, COMM_MSG, REPO_NO) VALUES (SEQ_COMM.NEXTVAL, 1, DEFAULT, '로그인 기능 수정', 1);
INSERT INTO PRO_COMMIT (COMM_NO, COMM_WRITER, COMM_DATE, COMM_MSG, REPO_NO) VALUES (SEQ_COMM.NEXTVAL, 1, DEFAULT, '좋아요 기능 버그 수정', 2);
INSERT INTO PRO_COMMIT (COMM_NO, COMM_WRITER, COMM_DATE, COMM_MSG, REPO_NO) VALUES (SEQ_COMM.NEXTVAL, 1, DEFAULT, '레파지토리 등록 기능 추가', 3);
INSERT INTO PRO_COMMIT (COMM_NO, COMM_WRITER, COMM_DATE, COMM_MSG, REPO_NO) VALUES (SEQ_COMM.NEXTVAL, 1, DEFAULT, '신고 기능 삭제', 4);
INSERT INTO PRO_COMMIT (COMM_NO, COMM_WRITER, COMM_DATE, COMM_MSG, REPO_NO) VALUES (SEQ_COMM.NEXTVAL, 1, DEFAULT, '마이페이지 기능 코드 수정', 5);
